...
def Lookuplin(MyFile, inputcol, searchcol, inputvalue):
    ...
    minTableValue=MyFile[:,inputcol].min()
    maxTableValue=MyFile[:,inputcol].max()
    ...
    A = MyFile[MyFile[:,inputcol] <= inputvalue,inputcol].max()
    B = MyFile[MyFile[:,inputcol] > inputvalue,inputcol].min()
    C = MyFile[MyFile[:,inputcol] == A,searchcol].max()
    D = MyFile[MyFile[:,inputcol] == B,searchcol].min()
