...
def get_model_for_problem_formulation(problem_formulation_id):
    ...
    # 17-objectives PF:
        ...
        for dike in function.dikelist:
            for entry in ['Expected Annual Damage', 'Dike Investment Costs',
                ...
                o = ScalarOutcome('{}_{}'.format(dike, entry), kind="minimize")
                outcomes.append(o)
    ...
    # 1,3 / 2,5 / 4
        ...
        dike_model.outcomes = [
        # Annual Damage
          ScalarOutcome('Expected Annual Damage(1/3)',
                        variable_name=['{}_Expected Annual Damage'.format(dike) for dike in ["A.1","A.3"]],
                        function=sum_over, kind=direction),

          ScalarOutcome('Expected Annual Damage(2/5)',
                        variable_name=['{}_Expected Annual Damage'.format(dike) for dike in ["A.2","A.5"]],
                        function=sum_over, kind=direction),

          ScalarOutcome('Expected Annual Damage(4)',
                        variable_name='{}_Expected Annual Damage'.format("A.4"),
                        kind=direction),
        # Number of Deaths
          ScalarOutcome('Expected Number of Deaths(1/3)',
                        variable_name=['{}_Expected Number of Deaths'.format(dike) for dike in ["A.1","A.3"]],
                        function=sum_over, kind=direction),
          ScalarOutcome('Expected Number of Deaths(2/5)',
                        variable_name=['{}_Expected Number of Deaths'.format(dike) for dike in ["A.2","A.5"]],
                        function=sum_over, kind=direction),
          ScalarOutcome('Expected Number of Deaths(4)',
                        variable_name='{}_Expected Number of Deaths'.format("A.4"),
                        kind=direction),
        # Costs
          ScalarOutcome('Dike Investment Costs(1/3)',
                        variable_name=['{}_Dike Investment Costs'.format(dike) for dike in ["A.1","A.3"]],
                        function=sum_over, kind=direction),
          ScalarOutcome('Dike Investment Costs(2/5)',
                        variable_name=['{}_Dike Investment Costs'.format(dike) for dike in ["A.2","A.5"]],
                        function=sum_over, kind=direction),
          ScalarOutcome('Dike Investment Costs(4)',
                        variable_name='{}_Dike Investment Costs'.format("A.4"),
                        kind=direction),

          ScalarOutcome('RfR Total Costs',
                        variable_name='RfR Total Costs', kind=direction),

          ScalarOutcome('Expected Evacuation Costs',
                        variable_name='Expected Evacuation Costs', kind=direction),
                        ]
    # modified-objectives
    # 1,3 / 2,5 / 4
